...
function useTweaks<T>(defaults: T) {
  ...
  const setTweak = React.useCallback((keyOrEdits: string | Record<string, unknown>, val?: unknown) => {
    ...
    setValues((prev: T) => ({ ...prev, ...edits }) as T);
...
function TweakRadio({ label, value, options, onChange }: { label?: string; value: string; options: Array<string | { value: string; label: string }>; onChange: (v: string) => void }) {
...
function TweakSelect({ label, value, options, onChange }: { label?: string; value: string; options: Array<string | { value: string; label: string }>; onChange: (v: string) => void }) {
  return (
    <TweakRow label={label}>
